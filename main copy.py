...
# #now we gonna cover the dictionary, student grade's book
# grades = {"Jayson": "A",
#           "Fernando": "A",
#           "Banana": "C",
#           "Pat": "B"}
...
# if student in grades:#once we find the student that we want, we have to get that value at that given key
#     print(f"{student}'s grade is {grades[student]}")  # by take our dictionary of grades add index of student [student]
# else:
#     print(f"{student} was not found")

# #create email
# email = "Brolearning@gmail.com"
# #we would like to see is the email valid by does the email contain @ and the period
...
# doubles = []
# for x in range(1, 11):   #remember in the range(x, y) function, the second number "y" is exclusive (จิงๆคือ y-1) ดังนั้นตั้งใจอยากได้เลขอะไรให้บวก1 เช่นอยากได้ 1 ถึง 10
#     doubles.append(x * 2)  #.append = add a new item to the end of a list.

# print(doubles)
# #but this is a lot to write, so we can use a list comprehension to make this code more compact and easier to read

# doubles = [x * 2 for x in range(1,11)] #this is more compact code (aka use the formula) [expression for value in iterable]
# print(doubles)
...
# #list of fruits
# fruits = ["apple", "orange", "banana", "coconut"]
# #use this method [expression for value in iterable if condition] to make the fruit in the list uppercase
# fruits = [fruit.upper() for fruit in fruits] #expression = fruit.upper(), and the value = fruit, and in iterable is for loop
# print(fruits)

# #you could shorten the step by 
# fruits = [fruit.upper() for fruit in ["apple", "orange", "banana", "coconut"]]
# print(fruits)

# #now instead of making eacah string uppercase, we'll take the first letter of each string.
# fruits = ["apple", "orange", "banana", "coconut"]
# fruits_chars = [fruit[0] for fruit in fruits] 
# print(fruits_chars)

# #now work with condition
# numbers = [1, -2, 3, -4, 5, -6, 8, -7]
# positive_nums = [num for num in numbers if num >= 0] #expression = num, and the value = num, and in iterable is for loop, plus condition = if num >= 0
# print(positive_nums)
# negative_nums = [num for num in numbers if num < 0]
# print(negative_nums)
# even_nums = [num for num in numbers if num % 2 == 0] #modulus operator will give you the remainder of any division, ถ้าเป็นเลขคู่ต้องหารแล้ว2แล้วเหลือเศษ0
# #num % 2 → remainder when dividing by 2.
# print(even_nums)
# odd_nums = [num for num in numbers if num % 2 == 1] #It’s odd because num % 2 == 1 is true only for odd numbers as ถ้าหารด้วยเลขคู่แล้วเหลือเศษ 1
# print(odd_nums)

# #create a list of grade(any list of a passing grade aka they scored 60 or above)
# grades = [85, 42, 79, 90, 56, 62, 50]
# passing_grades = [grade for grade in grades if grade >= 60]
# #expression = grade, and the value = grade, and in iterable is for loop(aka for grade in grades), plus condition = if grade >= 60
...
# # Match-case statement (switch): An alternative to using many 'elif' aka 'else if ' statements Execute some code if a value matches a 'case'
# #                                Benefits-> cleaner and syntax is more readable


# #function with one parameter "day"
# def day_of_week(day):
#     if day == 1:
#         return "It is Sunday"
#     elif day == 2:
...
# print(day_of_week(1))  #example if day equal 1 its mean It is Sunday, 2, 3, ... but we also have an else clause if we pass on something invalid.
# ##But overall this, this can improve to make it cleaner and more readable alternative
# ## By using a match-case statement instead of many elif (else if) statement
# def day_of_week(day):
#     match day:  #match-case, the case gonna be the value we're examining, which is "day"
#         case 1:  #so now we can replace elif day == with just "case"
#             return "It is Sunday"
#         case 2:
#             return "It is Monday"
#         case 3:
...
#         case 7:
#             return "It is Saturday"
#         case _: #if you have an else statement, you need to replace with the "case _" this is a wild card 
#             return "Not a valid day"
        
# print(day_of_week(1)) #example if day equal 1 its mean It is Sunday, 2, 3, ... but we also have an wild card "case _" if we pass on something invalid.

# #example 2 function of is it weekend or not, this time our day gonna be a string (aka the value for each case instead of a number is gonna be string)
# def is_weekend(day):
#     match day:  #match-case, the case gonna be the value we're examining, which is "day"
#         case "Sunday": #now the value of each case instead of a number is going to be a string ex Sunday instead of 1
#             return True
#         case "Monday":
#             return False
#         case "Tuesday":
...
# #we're gonna use the "|" (aka "|" is "or")
# def is_weekend(day):
#     match day:  #match-case, the case gonna be the value we're examining, which is "day"
#         case "Saturday" | "Sunday": # => if the case of Sat or Sun it will return TRUE
#             return True
...
# print(is_weekend("Saturday"))
# #These are Match-case statement (aka alternative for using many elif statement)
